...
exports.handler = async function(event) {
  ...
  const ADDRESS = '0xb21f25274e873240f0CEe29B8548C551B307BAc3';
  const ABI = [
		{
			"inputs": [
				{
		...
		},
		{
			"inputs": [
				...
				{
					"internalType": "uint8",
					"name": "_oracleForCreationValidation1",
					"type": "uint8"
				},
				{
					"internalType": "uint8",
					"name": "_oracleForCreationValidation2",
					"type": "uint8"
				},
				{
					"internalType": "uint8",
					"name": "_oracleForContestScoring1",
					"type": "uint8"
				},
				{
					"internalType": "uint8",
					"name": "_oracleForContestScoring2",
					"type": "uint8"
				}
			],
			"name": "createContest",
  ...
  const tx = await contract.scoreContest(value);
